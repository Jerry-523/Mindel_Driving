...
public class RegisterActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_cadastrar.setOnClickListener(view -> {
            ...
            if (nome.isEmpty() || email.isEmpty() || senha.isEmpty()){
                ...
                mAuth.createUserWithEmailAndPassword(email, senha).addOnCompleteListener(RegisterActivity2.this, task -> {
        ...
        login.setOnClickListener(view -> startActivity(new Intent(RegisterActivity2.this,LoginActivity.class)));
    }
    ...
    private void SalvarDadosUsuario(){
        ...
        DocumentReference documentReference2 = db.collection("Customer").document(usuarioID);
